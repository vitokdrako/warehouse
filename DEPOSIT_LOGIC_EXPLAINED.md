...
## Огляд
Система тепер підтримує два типи депозиту:
...
### Приклад 1: Депозит у гривнях (як очікувалось)
```
Замовлення #6990
Очікувана застава: ₴ 12 075 (розрахункова)
Фактична застава: ₴ 12 075 (прийнято від клієнта)
```

### Приклад 2: Депозит в іноземній валюті
```
Замовлення #6994
Очікувана застава: ₴ 800 (розрахункова)
Фактична застава: $ 100 USD + ₴ 800 (прийнято від клієнта)
```
